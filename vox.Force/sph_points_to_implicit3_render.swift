//
//  sph_points_to_implicit3_render.swift
//  vox.Force
//
...
class SphPointsToImplicit3Renderable: Renderable {
    ...
    func ConvertTwo() {
        ...
        let converter = SphPointsToImplicit3(kernelRadius: 0.3)
    ...
    func ConvertMany() {
        ...
        let converter = SphPointsToImplicit3(kernelRadius: 0.1)
        converter.convert(points: points.constAccessor(), output: &grid)
