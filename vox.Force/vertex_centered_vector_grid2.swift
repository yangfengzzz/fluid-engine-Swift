//
//  vertex_centered_vector_grid2.swift
//  vox.Force
//
...
final class VertexCenteredVectorGrid2: CollocatedVectorGrid2 {
    ...
    /// Copy constructor.
    init(other:VertexCenteredVectorGrid2) {
        super.init()
        set(other: other)
    }
    ...
    override func swap(other: inout Grid2) {
        let sameType = other as? VertexCenteredVectorGrid2
        if (sameType != nil) {
    ...
    func set(other:VertexCenteredVectorGrid2) {
    ...
    override func clone()->VectorGrid2 {
        return VertexCenteredVectorGrid2(other: self)
    }
    
    //MARK:- Builder
    /// Front-end to create VertexCenteredVectorGrid2 objects step by step.
    class Builder: VectorGridBuilder2{
        ...
        func build()->VertexCenteredVectorGrid2 {
            return VertexCenteredVectorGrid2(
