//
//  spherical_points_to_implicit3_render.swift
//  vox.Force
//
...
class SphericalPointsToImplicit3Renderable: Renderable {
    ...
    func ConvertTwo() {
        ...
        let converter = SphericalPointsToImplicit3(kernelRadius: 0.3)
    ...
    func ConvertMany() {
        ...
        let converter = SphericalPointsToImplicit3(kernelRadius: 0.1)
        converter.convert(points: points.constAccessor(), output: &grid)
