...
///
class Bvh2<T> : IntersectionQueryEngine2&NearestNeighborQueryEngine2{
    ...
    func nodeBound(i:size_t)->BoundingBox2F{
    ...
    private struct Node {
        var flags:UInt8 = 0
        var bound:BoundingBox2F = BoundingBox2F()
        ...
        mutating func initLeaf(it:size_t, b:BoundingBox2F){
            flags = 2
            item = it
            bound = b
        }
        
        mutating func initInternal(axis:UInt8, c:size_t, b:BoundingBox2F){
            flags = axis
            child = c
            bound = b
        }
    ...
    private var _bound:BoundingBox2F = BoundingBox2F()
    private var _items:[T] = []
    private var _itemBounds:[BoundingBox2F] = []
