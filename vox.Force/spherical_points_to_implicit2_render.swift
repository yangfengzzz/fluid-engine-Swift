//
//  spherical_points_to_implicit2_render.swift
//  vox.Force
//
...
class SphericalPointsToImplicit2Renderable: Renderable {
    ...
    func ConvertTwo() {
        ...
        let converter = SphericalPointsToImplicit2(kernelRadius: 0.1)
