//
//  vertex_centered_vector_grid2.metal
//  vox.Force
//
...
#ifndef INCLUDE_VOX_VERTEX_CENTERED_VECTOR_GRID2_METAL_
#define INCLUDE_VOX_VERTEX_CENTERED_VECTOR_GRID2_METAL_
...
public:
    ...
    //! initial value.
    VertexCenteredVectorGrid2(device float2* data,
...
#endif  // INCLUDE_VOX_VERTEX_CENTERED_VECTOR_GRID2_METAL_
