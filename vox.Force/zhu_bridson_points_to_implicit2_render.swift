//
//  zhu_bridson_points_to_implicit2_render.swift
//  vox.Force
//
...
class ZhuBridsonPointsToImplicit2Renderable: Renderable {
    ...
    func ConvertTwo() {
        ...
        let converter = ZhuBridsonPointsToImplicit2(kernelRadius: 0.1)
