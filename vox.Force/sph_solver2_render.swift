...
class SphSolver2Renderable: Renderable {
    ...
    func WaterDrop() {
        ...
        surfaceSet.addExplicitSurface(surface: Plane2(normal: Vector2F(0, 1),
                                                      point: Vector2F(0, 0.25 * domain.height())))
        surfaceSet.addExplicitSurface(surface: Sphere2(center: domain.midPoint(),
                                                       radiustransform: 0.15 * domain.width()))
    ...
    func WaterDropLargeDt() {
        ...
        solver.setCollider(newCollider: collider)
        solver.setTimeStepLimitScale(newScale: 10.0)
    }
