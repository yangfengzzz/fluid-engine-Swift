...
class sph_system_data3_tests: XCTestCase {
    ...
    func testParticles() {
        ...
        data.addParticle(newPosition: Vector3F(0, 0, 0))
        data.addParticle(newPosition: Vector3F(1, 0, 0))
        ...
        let midVal = data.interpolate(origin: Vector3F(0.5, 0, 0),
