//
//  grid_forward_diffusion_solver2_tests.swift
//  vox.ForceTests
//
...
class grid_forward_diffusion_solver2_tests: XCTestCase {
    ...
    func testSolve() throws {
        ...
        let diffusionSolver = GridForwardEulerDiffusionSolver2()
        ...
        let solution = Array2<Float>(lst: [
            [0.0,     Float(1.0)/8.0, 0.0],
            [Float(1.0)/8.0, Float(1.0)/2.0, Float(1.0)/8.0],
            [0.0,     Float(1.0)/8.0, 0.0]
        ])
