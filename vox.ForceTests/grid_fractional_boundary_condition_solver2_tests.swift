//
//  grid_fractional_boundary_condition_solver2_tests.swift
//  vox.ForceTests
//
...
class grid_fractional_boundary_condition_solver2_tests: XCTestCase {
    ...
    func testClosedDomain() throws {
        let bndSolver = GridFractionalBoundaryConditionSolver2()
