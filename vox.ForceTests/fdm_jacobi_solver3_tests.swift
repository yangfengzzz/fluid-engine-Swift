//
//  fdm_jacobi_solver3_tests.swift
//  vox.ForceTests
//
...
class fdm_jacobi_solver3_tests: XCTestCase {
    ...
    func testSolve() throws {
        ...
        let solver = FdmJacobiSolver3(maxNumberOfIterations: 100,
                                      residualCheckInterval: 10, tolerance: 1e-5)
