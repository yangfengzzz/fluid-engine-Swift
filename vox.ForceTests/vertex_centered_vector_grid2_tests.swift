//
//  vertex_centered_vector_grid2_tests.swift
//  vox.ForceTests
//
...
class vertex_centered_vector_grid2_tests: XCTestCase {
    ...
    func testConstructors() throws {
        ...
        let grid1 = VertexCenteredVectorGrid2()
        ...
        let grid2 = VertexCenteredVectorGrid2(resolutionX: 5, resolutionY: 4,
        ...
        // Copy constructor
        let grid3 = VertexCenteredVectorGrid2(other: grid2)
    ...
    func testSwap() {
        let grid1 = VertexCenteredVectorGrid2(resolutionX: 5, resolutionY: 4,
                                              gridSpacingX: 1.0, gridSpacingY: 2.0,
                                              originX: 3.0, originY: 4.0,
                                              initialValueU: 5.0, initialValueV: 6.0)
        let grid2 = VertexCenteredVectorGrid2(resolutionX: 3, resolutionY: 8,
    ...
    func testAssignmentOperator() {
        var grid1 = VertexCenteredVectorGrid2(resolutionX: 5, resolutionY: 4,
                                              gridSpacingX: 1.0, gridSpacingY: 2.0,
                                              originX: 3.0, originY: 4.0,
                                              initialValueU: 5.0, initialValueV: 6.0)
        let grid2 = VertexCenteredVectorGrid2(resolutionX: 3, resolutionY: 8,
    ...
    func testBuilder() {
        ...
        XCTAssertEqual(1.0, grid2!.dataOrigin().x)
        ...
        let grid3 = VertexCenteredVectorGrid2.builder()
        ...
        XCTAssertEqual(1.0, grid3.dataOrigin().x)
    ...
    func testFill() {
        let grid = VertexCenteredVectorGrid2(resolutionX: 5, resolutionY: 4,
    ...
    func testDivergenceAtDataPoint() {
        let grid = VertexCenteredVectorGrid2(resolutionX: 5, resolutionY: 8,
                                             gridSpacingX: 2.0, gridSpacingY: 3.0)
