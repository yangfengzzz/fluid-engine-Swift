//
//  cell_centered_vector_grid3_tests.swift
//  vox.ForceTests
//
...
class cell_centered_vector_grid3_tests: XCTestCase {
    ...
    func testConstructors() throws {
        ...
        let grid1 = CellCenteredVectorGrid3()
        ...
        let grid2 = CellCenteredVectorGrid3(
        ...
        // Copy constructor
        let grid3 = CellCenteredVectorGrid3(other: grid2)
    ...
    func testAssignmentOperator() {
        var grid1 = CellCenteredVectorGrid3(
            resolutionX: 5, resolutionY: 4, resolutionZ: 3,
            gridSpacingX: 1.0, gridSpacingY: 2.0, gridSpacingZ: 3.0,
            originX: 4.0, originY: 5.0, originZ: 6.0,
            initialValueU: 7.0, initialValueV: 8.0, initialValueW: 9.0)
    ...
    func testBuilder() {
        ...
        XCTAssertEqual(5, grid2!.dataSize().z)
        XCTAssertEqual(6.0, grid2!.dataOrigin().x)
        XCTAssertEqual(5.5, grid2!.dataOrigin().y)
        XCTAssertEqual(7.5, grid2!.dataOrigin().z)
        grid2!.forEachDataPointIndex(){(i:size_t, j:size_t, k:size_t) in
        ...
        let grid3 = CellCenteredVectorGrid3.builder()
            ...
            .withOrigin(gridOriginX: 5.0, gridOriginY: 4.0, gridOriginZ: 7.0)
            .withInitialValue(initialValX: 8.0, initialValY: 1.0, initialValZ: 3.0)
            .build()
        ...
        XCTAssertEqual(5, grid3.dataSize().z)
        XCTAssertEqual(6.0, grid3.dataOrigin().x)
        XCTAssertEqual(5.5, grid3.dataOrigin().y)
        XCTAssertEqual(7.5, grid3.dataOrigin().z)
        grid3.forEachDataPointIndex(){(i:size_t, j:size_t, k:size_t) in
    ...
    func testFill() {
        let grid = CellCenteredVectorGrid3(
    ...
    func testDivergenceAtDataPoint() {
        let grid = CellCenteredVectorGrid3(resolutionX: 5, resolutionY: 8, resolutionZ: 6)
