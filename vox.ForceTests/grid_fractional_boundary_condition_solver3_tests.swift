//
//  grid_fractional_boundary_condition_solver3_tests.swift
//  vox.ForceTests
//
...
class grid_fractional_boundary_condition_solver3_tests: XCTestCase {
    ...
    func testClosedDomain() throws {
        let bndSolver = GridFractionalBoundaryConditionSolver3()
